...
export default function BlogsSection() {
  ...
  const t = useTranslations("blogs_section")
            ...
            return (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <span className={`absolute top-4 ${locale === 'ar' ? 'left-4' : 'right-4'} px-3 py-1 rounded-full text-xs font-semibold ${getCategoryColor(blog.category)}`}>
                    {blog.category}
                  </span>
                </div>
                <div className="p-6">
                  ...
                  <div className="flex items-center text-green-600 font-semibold group-hover:gap-3 transition-all">
                    {t("read_more")}
                    <ArrowRight className={`w-4 h-4 ${locale === 'ar' ? 'mr-2 group-hover:-translate-x-1' : 'ml-2 group-hover:translate-x-1'} transition-transform`} />
                  </div>
                </div>
              </Link>
            )
